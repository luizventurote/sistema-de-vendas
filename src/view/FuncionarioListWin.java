 ...
 * @author Luiz
 */
public class FuncionarioListWin extends javax.swing.JDialog {
    ...
    public FuncionarioListWin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public FuncionarioListWin(java.awt.Frame parent, boolean modal, boolean select) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioListWin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncionarioListWin dialog = new FuncionarioListWin(new javax.swing.JFrame(), true);
